class UpdatePhoneCallStatus < ApplicationWorkflow
  ...
  attr_reader :event_type, :answer_epoch, :sip_term_status
  ...
  def handle_complete_event
    ...
    return phone_call.not_answered! if NOT_ANSWERED_SIP_TERM_STATUSES.include?(sip_term_status)
    return phone_call.busy! if BUSY_SIP_TERM_STATUSES.include?(sip_term_status)
