...
describe PhoneCall do
  ...
  describe "json" do
    ...
    describe "#to_internal_outbound_call_json" do
      ...
      def assert_valid_json!
        expect(json.keys).to match_array(["sid", "account_sid", "account_auth_token", "voice_url", "voice_method", "from", "to", "routing_instructions"])
      end
    ...
    describe "#to_internal_inbound_call_json" do
      ...
      def assert_valid_json!
        expect(json.keys).to match_array(["sid", "account_sid", "account_auth_token", "voice_url", "voice_method", "from", "to", "twilio_request_to"])
      end
