...
describe Usage::Record::Collection do
  ...
  describe "validations" do
    ...
    it { is_expected.to validate_inclusion_of(:category).in_array(["calls", "calls-inbound", "calls-outbound"]) }
