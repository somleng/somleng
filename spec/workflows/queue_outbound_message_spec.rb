...
RSpec.describe QueueOutboundMessage do
  it "queues a message" do
    ...
    expect(message.sending?).to eq(true)
  end
  ...
  it "marks the message as failed if there are no senders" do
    ...
    expected_error = TwilioAPI::Errors::MessagingServiceBlankError.new
    ...
    expected_error = TwilioAPI::Errors::MessagingServiceNoSendersAvailableError.new
