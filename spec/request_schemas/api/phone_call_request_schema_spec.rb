...
module API
  RSpec.describe PhoneCallRequestSchema, type: :request_schema do
    ...
    it { expect(described_class.call(To: "+855 97 2345 678").output.fetch(:To)).to eq("+855972345678") }
    it { expect(described_class.call(To: "097 2345 678").output.fetch(:To)).to eq("0972345678") }
