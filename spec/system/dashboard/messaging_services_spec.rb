...
RSpec.describe "Messaging Services" do
  ...
  it "Shows a messaging service" do
    ...
    sender = create(:messaging_service_sender, messaging_service:, number: "855715999999")
    ...
    expect(page).to have_link(
      "855715999999",
      href: dashboard_phone_number_path(sender.phone_number)
    )
    expect(page).to have_content("My Messaging Service")
  end
  ...
  it "Create a messaging service" do
    ...
    expect(page).to have_field("Name", with: "My Messaging Service")
  ...
  it "Update a messaging service" do
    ...
    create(:messaging_service_sender, messaging_service:, number: "855715999999")
    create(
      :phone_number,
    ...
    expect(page).to have_content("My Messaging Service")
    expect(page).to have_content("855715777777")
    expect(page).to have_content("855715888888")
